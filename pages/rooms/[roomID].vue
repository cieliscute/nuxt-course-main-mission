  ...
  <main class="mt-18 mt-md-30 bg-neutral-100">
    <section class="p-md-20 bg-primary-10">
      <div class="d-none d-md-block position-relative">
        <div class="d-flex gap-2 rounded-3xl overflow-hidden">
          <div style="width: 52.5vw;">
            <img class="w-100" src="/public/images/room-a-1.png" alt="room-a-1">
          </div>
          <div class="d-flex flex-wrap gap-md-2" style="width: 42.5vw;">
            <div class="d-flex gap-md-2">
              <img class="w-50" src="/public/images/room-a-2.png" alt="room-a-2">
              <img class="w-50" src="/public/images/room-a-3.png" alt="room-a-3">
            </div>
            <div class="d-flex gap-md-2">
              <img class="w-50" src="/public/images/room-a-4.png" alt="room-a-4">
              <img class="w-50" src="/public/images/room-a-5.png" alt="room-a-5">
            </div>
          </div>
        </div>
        <button
      ...
      <div class="d-md-none position-relative">
        <img class="img-fluid" src="/public/images/room-a-1.png" alt="room-a-1">
        <button
        ...
        <div class="row">
          ...
          <div class="d-none d-md-block col-md-5">
            <div class="rounded-3xl position-sticky d-flex flex-column gap-10 p-10 ms-auto bg-neutral-0"
              ...
              <NuxtLink :to="{ name: 'booking', params: { roomId: $route.params.roomId } }"
